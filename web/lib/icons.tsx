/** Inline SVG icon components — stroke-based, scales via `size` prop. */
...
/** Star — used for the "Chef's Kiss" reaction (top marks / perfection). */
...
/** Droplet — used for the butter pour tableside trigger. */
export function DropletIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
/** Sparkles — used for the dessert reveal tableside trigger. */
export function SparklesIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M12 3l1.09 3.36L16.45 7l-3.36 1.09L12 11l-1.09-3.36L7.55 7l3.36-1.09L12 3z" />
      <path d="M5 12l.55 1.68L7.23 14l-1.68.55L5 16l-.55-1.68L2.77 14l1.68-.55L5 12z" />
      <path d="M19 12l.55 1.68L21.23 14l-1.68.55L19 16l-.55-1.68L16.77 14l1.68-.55L19 12z" />
    </svg>
  )
}

export function MusicNoteIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
/** Warning triangle — used to replace ⚠ warning text. */
...
/** Wine/cocktail glass — used for The Pour tableside trigger. */
export function GlassIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M8 22h8" />
      <path d="M12 11v11" />
      <path d="M5 3l2 8a5 5 0 0 0 10 0l2-8H5z" />
    </svg>
  )
}

/** Fork and knife crossed — used for The Bite tableside trigger. */
...
/** House outline — used for Main Flow nav button. */
...
/** Smile face outline — used for Add Reaction nav button. */
export function SmileIcon({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
/** Plus sign — used for Request Song nav button. */
...
/** Download arrow — used to replace 📥 emoji in photo booth actions. */
...
/** Share / upload arrow — used to replace 📤 emoji in photo booth actions. */
